            ...
            <div style="display:none" id="addSubjectForm">
                <form action="addsubjectFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subjectcode" name="SC" placeholder="MCAN 301,MCAN 302">
                    </div>
                    <div class="form-group">
                    ...
                    <option selected disabled>Select Subject</option>';
                                while ($row = mysqli_fetch_assoc($q)) {
                                    $mystring .= '<option value="' . $row['dept_id'] . '">' . $row['department'] .  '</option>';
                                }
...
<div>
    ...
    <table id=subjectstable style="margin-left: 90px">
        ...
        include 'connection.php';
        $q = mysqli_query($con,
            "SELECT * FROM subjects inner join department on subjects.dept_id=department.dept_id ");
        while ($row = mysqli_fetch_assoc($q)) {
