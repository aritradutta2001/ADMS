...
<body>
    <center><h1>Generate Time Table For Semester2</h1></center>
...
Tuesday" required></td>
            <td style="text-align:center">
              ...
              <?php
                ...
                $q = mysqli_query($con,
                    "SELECT * FROM subjects where semester =2");
...
if(isset($_POST["submit"]))
{
	...
	$sql="Insert INTO semester2 Values('$tuesday','$period1day1','$period2day1','$period3day1','$period4day1','$period5day1','$period6day1','$period7day1'),
