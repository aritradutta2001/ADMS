...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">CIT TIME TABLE MANAGEMENT SYSTEM, MCA DEPARTMENT</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/CIT1.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/CIT2.jpeg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/CIT1.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/CIT2.jpeg" alt="Flower">
        </div>
    </div>
</div>
...
<!--<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="1">MCA 1st sem </option>
            <option value="2">MCA 2nd sem </option>
            <option value="3">MCA 3rd sem </option>
            <option value="4">MCA 4th sem </option>
